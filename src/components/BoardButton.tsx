...
import { Badge, Dialog, DialogTitle, Grid, Slide, Stack } from '@mui/material'
...
export const BoardButton: FC<IBoardButtonProps> = (props) => {
    ...
    return (
        <>
            ...
            <Dialog open={open} onClose={() => setOpen(false)} slots={{ transition: Slide }}>
                <Stack direction={'row'} justifyContent={'space-between'}>
                    <DialogTitle>TBD Editing</DialogTitle>
                    <IconButton {...buttonBaseProps} style={{ marginInlineEnd: 8 }} onClick={() => setOpen(false)}>
                        <Close />
                    </IconButton>
                </Stack>
