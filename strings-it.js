...
export const idStringsIT = {
    ...
    longNamesCompatibilityModeText: "<span class='text-primary'>Consigliato</span> Attivalo per mostrare i nomi dei giocatori in verticale, evitando di stringere troppo la tabella.<br>Disattivalo per mostrare i nomi normalmente.",
    ...
    forceAssistantUpdateText: "Attivalo per permettere all'assistente di sovrascrivere tutti i riquadri nella tabella.<br><span class='text-primary'>Consigliato</span> Disattivalo per far sovrascrivere solo i riquadri vuoti.",
    ...
    autocompleteText: "<span class='text-primary'>Consigliato</span> Attivalo per inserire le croci<span class=\"material-symbols-outlined\">close</span> automaticamente ogni volta che metti una spunta<span class=\"material-symbols-outlined\">done</span> su una carta.<br>Disattivalo per inserire le croci manualmente.",
