...
const stringsIT = {
    ...
    playerNumTooltip: "3",
    playerNameTooltip: "Cerca di usare nomi corti.<br>Scrivi i nomi dei giocatori in senso orario, partendo dal giocatore alla tua sinistra.",
    readyText: "Pronti?",
